      ...
      <div class="container text-center">
          ...
          <div class="row mt-4">
              <div class="col-lg-4 footer-contact-col mb-4 mb-lg-0">
                  <h6>Our Office</h6>
                  <p class="mb-0">Swinburne Sarawak<br>Kuching, Sarawak</p>
              </div>
              <div class="col-lg-4 footer-contact-col mb-4 mb-lg-0">
                  <h6>Contact Us</h6>
                  <p class="mb-1"><a href="tel:1234567890" style="color: #DCD7C9;">(+60) 145-7890</a></p>
                  <p class="mb-0"><a href="mailto:tarabhasker26@gmail.com" style="color: #DCD7C9;">hello@reallygreatsite.com</a></p>
              </div>
              <div class="col-lg-4 footer-contact-col mb-4 mb-lg-0">
                  <h6>Office Hours</h6>
